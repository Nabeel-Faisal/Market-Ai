        ...
        <Reveal key={`${idPrefix}-${index}`} delay={index * 0.04} duration={0.5}>
          ...
          >
            <AccordionPrimitive.Header>
              <AccordionPrimitive.Trigger className="flex w-full items-start justify-between gap-5 px-6 py-5 text-left font-display text-[1.0625rem] font-semibold leading-snug text-foreground transition-colors hover:text-brand">
                {question}
